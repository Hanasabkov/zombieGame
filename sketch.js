...
function setup(){
    ...
    heart = createSprite(600,100)
    heart.addImage(heartImg);
    heart.scale=0.1;

    heart1 = createSprite(660,100)
    heart1.addImage(heartImg);
    heart1.scale=0.1;

    heart2 = createSprite(720,100)
...
//rules
    ...
    if(player.isTouching(spookGroup)||player.isTouching(handGroup)){
        growl.play();
...
function spawnSpook(){
    if(frameCount % 150 === 0){
        ...
        spook.setCollider("circle",0,0,1);
    }
}
...
function spawnSpook2(){
    if(frameCount % 260 === 0){
        var spook1= createSprite(400,280,10,40);
